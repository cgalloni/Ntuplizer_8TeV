...
'dcap://t3se01.psi.ch/pnfs/psi.ch/cms/trivcat/store/t3groups/uniz-higgs/pattuple/mc/aniello/AbelianZprime_M-1000_hZ_tautauqq_LHCC_NEW-Madgraph5_V2_12082013/EDBR_Signal/fd7ea13d876c4bb94f8635681f4024eb/AbelianZprime_M-1000_hZ_tautauqq_LHCC_NEW-Madgraph5_V2_12082013__caber-AbelianZprime_M-1000_hZ_tautauqq_LHCC-Madgraph5_13082013_V2_AODSIM-c8f8ed334db8a7d6f56c62266b1dfa5b__USER_1_1_jDT.root',

)

#options.inputFiles = 'file:patTuple.root'
...
if runOnMC is False:
  ...
  process.p = cms.Path(process.badEventFilter*(process.myPartons+process.flavourByRef+process.flavourByVal+process.ntuplizer))
